Template.pagesAbout.onCreated(function () {
    this.factor = 2;
    this.cars = [{ "brand": "Seat", "models": ["Alhambra", "Altea", "Altea XL", "Arosa", "Cordoba", "Cordoba Vario", "Exeo", "Ibiza", "Ibiza ST", "Exeo ST", "Leon", "Leon ST", "Inca", "Mii", "Toledo"] },
...
Template.pagesAbout.onRendered(function () {
    const self = this;
    console.log(add(1, 2));
